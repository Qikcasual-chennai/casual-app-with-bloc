...
import 'package:casual_app/models/property/property_model.dart';

class CasualJobModel{
  int? id;
  ...
  CasualJobModel({this.id, this.casual_job_id, this.job_title, this.no_of_casuals, this.outlet_name,
  ...
  CasualJobModel.fromJson(Map<String, dynamic> json){
    id = json['id'];
    ...
    property = json['property'] != null ? new PropertyModel.fromJson(json['property']) : null;
